...
public class GrapplingShieldDisarmEnchantment extends Enchantment {
    public GrapplingShieldDisarmEnchantment() {
        super(
                Rarity.RARE,
    ...
    public static int getLevel(ItemStack stack) {
        ...
        return EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.GRAPPLING_SHIELD_DISARM.get(), stack);
    }
